...
export const venueSettings = pgTable("venue_settings", {
  ...
  automatedTaskRules: text("automatedTaskRules"),
  ...
  // JSON array of space-to-service mappings so different venue spaces push
  // to the correct NBI service/section.
  // Shape: [{ spaceName: string, serviceId: string, sectionId: string }]
  nbiServiceMappings: text("nbiServiceMappings"),
...
export const leads = pgTable("leads", {
  ...
  // Ad-click attribution, captured by the embed loader (embed.js) from the
  // PARENT page's URL at load time — the iframe itself can't see it,
  // cross-origin. Lets a venue answer "did this enquiry come from an ad,
  // and which one?" even if they never wire up conversion tracking.
